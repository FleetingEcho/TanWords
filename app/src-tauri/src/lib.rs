...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            db::db_save_writing_submission,
            db::db_list_writing_submissions,
            db::db_delete_writing_submissions,
            db::db_delete_writing_sentences,
            db::db_save_writing_summary,
            db::db_list_writing_summaries,
            db::db_delete_writing_summaries,
