...
/** The visual language shared by the two screens that stand in front of the
 *  app — the web sign-in gate and the desktop lock screen. Kept in one place
 *  so they cannot drift into looking like two different products. */
