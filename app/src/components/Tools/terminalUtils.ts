...
export const TERMINAL_THEME = {
  ...
  cyan: "#7dcfff", white: "#a9b1d6", brightBlack: "#414868", brightRed: "#ff899d",
  brightGreen: "#9fe044", brightYellow: "#faba4a", brightBlue: "#8db0ff",
  brightMagenta: "#c7a9ff", brightCyan: "#a4daff", brightWhite: "#c0caf5",
} as const;
...
export const TERMINAL_THEMES = {
  ...
  nord: {
    ...
    selectionBackground: "rgba(76, 86, 106, 0.65)", black: "#3b4252", red: "#bf616a",
  ...
  "catppuccin-mocha": {
    ...
    selectionBackground: "rgba(245, 224, 220, 0.28)", black: "#45475a", red: "#f38ba8",
    green: "#a6e3a1", yellow: "#f9e2af", blue: "#89b4fa", magenta: "#f5c2e7",
    cyan: "#94e2d5", white: "#bac2de", brightBlack: "#585b70", brightRed: "#f38ba8",
    brightGreen: "#a6e3a1", brightYellow: "#f9e2af", brightBlue: "#89b4fa",
