...
export const useNavStore = create<NavState>((set, get) => ({
  ...
  navigate: (page, wordId, settingsSection) => set({ page, wordId, settingsSection, chatSessionId: undefined }),
  openChatSession: (sessionId) => set({ page: "chat", wordId: undefined, settingsSection: undefined, chatSessionId: sessionId }),
}));
