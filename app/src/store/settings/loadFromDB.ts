...
import {
  ...
  type LayoutMode, type TerminalEngine, type TerminalRenderer, type TerminalColorScheme, type TerminalCustomAppearance,
} from "./types";
import {
...
export async function loadSettingsFromDB(set: StoreApi<SettingsState>["setState"], get: StoreApi<SettingsState>["getState"]) {
  try {
    ...
    set({
      ...
      terminalEngine: (["xterm", "ghostty"] as TerminalEngine[])
