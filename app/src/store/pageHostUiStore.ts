 ...
 *  `disableBlur` for `AppBackground`. Workspace terminals pair this signal
 *  with their focused pane id, so the same mode can remove both app chrome and
 *  workspace/pane chrome without unmounting sibling panes.
 *
 ...
 *  terminal-named for now; Phase 4 will generalize it when other page types can
 *  request immersive behaviour. */
