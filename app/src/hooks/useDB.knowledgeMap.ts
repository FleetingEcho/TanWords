...
export function useDBKnowledgeMap(){
 ...
 return useMemo(()=>({listKnowledgeMaps,createKnowledgeMap,deleteKnowledgeMap,getKnowledgeMap,addKnowledgeNodes,addMapWordsToVocabulary}),[listKnowledgeMaps,createKnowledgeMap,deleteKnowledgeMap,getKnowledgeMap,addKnowledgeNodes,addMapWordsToVocabulary]);
}
