/** Queue ordering helpers for the podcast player — the music-page pieces of
 *  the desktop `features/music/queue.ts` are gone, but the player still plays
 *  episode lists (e.g. "play all" on a feed), so the mode math stays. */
