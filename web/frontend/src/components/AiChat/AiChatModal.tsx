...
export function AiChatModal({ open, onClose, sessionId }: Props) {
  ...
  return (
    <Dialog open={open} onClose={onClose} maxWidth="max-w-none" className="w-[90vw] h-[85vh] top-[7.5vh] max-lg:top-0 max-lg:w-screen max-lg:h-dvh max-lg:rounded-none flex flex-col overflow-hidden p-0">
