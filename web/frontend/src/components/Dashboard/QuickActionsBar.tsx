...
import { ChatIcon, BookIcon } from "@/components/ui/icons";
...
export function QuickActionsBar() {
  ...
  const actions = [
    ...
    // Web: the second jump is Reading (music is desktop-only). Everything else
    // is one tap away in the nav anyway.
